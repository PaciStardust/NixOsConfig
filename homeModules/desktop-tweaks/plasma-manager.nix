...
in
{
  options.strdst-desktop-tweaks.plasma-manager.enable = lib.mkEnableOption "STRDST Plasma Manager";
  
  config = lib.mkIf config.strdst-desktop-tweaks.plasma-manager.enable {
